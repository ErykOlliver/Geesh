...
export default function BarChartBase(props: BarChartProps) {
    ...
    const bars = useMemo(() => {
        ...
        const dynamicSpacing = 10 * (Screen_Size.width / 1080);
        ...
        return props.data.map((value, index) => {
            ...
            const radius = 40 * (Screen_Size.width / 1080);
    ...
    return (
        ...
        <View style={{ width: '100%', height: chartHeight, display: 'flex', alignItems: 'center' }} onLayout={(event) => {
            ...
            <View style={{ display: 'flex', width: Screen_Size.width, height: sizeBottomBarOfMonths, paddingLeft: 75 * (Screen_Size.width / 1080), paddingTop: 10 * (Screen_Size.width / 1080), justifyContent: 'flex-start', alignItems: 'center' }}>
